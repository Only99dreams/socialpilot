      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-sm text-muted-foreground">Autonomous AI Social Media Manager</span>
          </motion.div>
          ...
          >
            SocialPilot studies your business, learns your brand voice, and autonomously 
